...
//Neutrals
  ...
  static const Color fullBlack = /*Color(0xff000000)*/ Color(0xFF000101);
  static const Color errorColor = Color(0xFFDD615C);
  static const Color errorShadow = Color(0xFFd64933);
