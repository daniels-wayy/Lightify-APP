...
import 'package:lightify/pages/main/settings/home_widgets/ui/widgets/home_widget_variants/home_widget_big_widget.dart';
import 'package:lightify/pages/main/settings/home_widgets/ui/widgets/page_widgets/home_widget_device_row_widget.dart';

class BigWidgetPage extends StatelessWidget {
  const BigWidgetPage({super.key, required this.selectedDevices, required this.onTap});
