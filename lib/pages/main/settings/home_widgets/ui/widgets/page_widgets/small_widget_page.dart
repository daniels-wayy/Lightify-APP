...
class SmallWidgetPage extends StatelessWidget {
  const SmallWidgetPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const Align(alignment: Alignment.center, child: HomeWidgetSmall(variant: HomeWidgetVariant.bigger)),
